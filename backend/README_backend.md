...
FastAPI service exposing dog diet endpoints; main entry is main.py (default port 5000).

## Run
- From repo root: `cd backend && python main.py`
- Docs: http://localhost:5000/docs

## Key endpoints
- POST /api/submit-dog-info
...
- models/database.py — asyncpg pool + helpers
- services/report_service.py — report selection logic

## Environment
- Set DATABASE_URL in backend/.env (see backend/.gitignore for filename)
- Dependencies: fastapi, uvicorn, asyncpg, pydantic, python-dotenv

## DB tables (public fields)
-- breedsAKC_IDs_v3: breed_name_AKC, breed_group_AKC, breed_size_categ_AKC, breed_life_expect_yrs, listed_DogDiet_MVP, food_recomm_product, dogapi_id
-- questions_home_dog_4Q_v2: breed_name_AKC, age_years_preReg, status_dietRelat_preReg

<!-- 
Breed list (alphabetical) for first 2 phases/projects: Beagle, Chihuahua, French Bulldog, Golden Retriever, Labrador Retriever, Shih Tzu, Yorkshire Terrier (Pitbull was in first list, but was replaced with "American Staffordshire Terrier" and "Staffordshire Bull Terrier" in second list)

INSTRUCTIONS: If a "pit bull", please choose American Staffordshire Terrier. (Staffordshire Bull Terrier also listed.) Or select Other/Mixed. Pit bull as "American Staffordshire Terrier" or "Staffordshire Bull Terrier" (_-_ lb (_-_ kg)) 
Later phases will ask more about traits, health, weight and other measurements, and others.
-- 

INSERT INTO breedsAKC_IDs_v3 (breed_name_AKC, dogapi_id)
VALUES ('Other, including other breeds, mixed breed, unsure, and others', '00000000-0000-0000-0000-000000000000'); 
VALUES ('American Staffordshire Terrier', '30a056b8-2bbe-4aa9-b874-c511eb2ca775'); 
VALUES ('Beagle', 'd8621d92-6558-451c-8631-a32e767026a0'); 
VALUES ('Chihuahua', '092dae18-86f4-4b41-a3f8-f57fab2f6f2c'); 
VALUES ('French Bulldog', '1fa29da4-8cc9-4f82-9c4d-cd93ee6dd6be'); 
VALUES ('Golden Retriever', 'fee91641-2a2e-4c4f-b557-cff67c5803bc'); 
VALUES ('Labrador Retriever', '9d7c4db8-b9cf-4ed3-af8e-86fc56fbf251'); 
VALUES ('Shih Tzu', 'e4aa816d-fb22-4841-80c4-b9967c310447'); 
VALUES ('Staffordshire Bull Terrier', '791fa86c-ff6c-49d9-92ee-b33c755ca50e'); 
VALUES ('Yorkshire Terrier', 'ce40589c-295a-4259-9e83-711854db8129')


283 breeds on 12/13
https://dogapi.dog/demo
GET /api/v2/breeds
  ...
  "data": [
    ...
    {
      "id": "b4233dc2-c233-4122-9f67-4c895a3717d5",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "5911839f-8018-483e-9008-c2be65c637a2",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "112c4528-17e4-4e35-bcc3-706340d26d04",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "3652f545-c185-4095-be91-277b3f1bd672",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "a864f5b7-1b1e-4e9c-9e2f-ef832605d5eb",
      "type": "breed",
      "attributes": {
        "name": "Broholmer",
    ...
    {
      "id": "0c6755a1-3877-4933-bc6d-08b8d197cefb",
      "type": "breed",
      "attributes": {
        "name": "Bull Terrier",
    ...
    {
      "id": "32e67add-67a8-481b-8179-1bd5ec79e8bb",
      "type": "breed",
      "attributes": {
        "name": "Cairn Terrier",
    ...
    {
      "id": "26fa8a54-2555-49f3-8d04-90ff84764295",
      "type": "breed",
      "attributes": {
        "name": "Carolina Dog",
    ...
    {
      "id": "0b8a1e9e-bd7f-4382-be78-be3d4429294a",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "bcb5c498-8585-4f4d-b45b-f1931752ee4a",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "2eb1ba4b-1fa2-40ab-827c-a1c1e6d28b17",
      "type": "breed",
      "attributes": {
        "name": "Cesky Terrier",
    ...
    {
      "id": "c500abe0-0ee1-4209-9767-08cc03e6abdf",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "84f73717-1814-42c6-90e6-33a047635dd7",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "c5b9b358-3237-48f3-ad12-7e1e8c0594ef",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "5462fedb-7f80-49c5-98c3-8ce3207e7d03",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "bc97ff27-930e-4d3a-95a8-5a8f2ad4c0e2",
      "type": "breed",
      "attributes": {
        "name": "Drever",
    ...
    {
      "id": "75d3913b-d716-405e-b07b-081e40ba89d0",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "553ed85b-84e5-481d-919c-bde4250ef1fb",
      "type": "breed",
      "attributes": {
        "name": "Eurasier",
    ...
    {
      "id": "27b8b673-5caa-4563-add8-8527a5c3762e",
      "type": "breed",
      "attributes": {
        "name": "French Spaniel",
    ...
    {
      "id": "8a78ce08-b3ae-4db0-9048-1354cddb7450",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "937f2454-44f4-4a1d-b938-cdcd5d930b20",
      "type": "breed",
      "attributes": {
        "name": "German Spitz",
    ...
    {
      "id": "6c12d646-c06e-47ae-b322-998b737f54c1",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "13d39af7-290b-4e8f-923b-4af0c93be1d3",
      "type": "breed",
      "attributes": {
        "name": "Hovawart",
    ...
    {
      "id": "7fb7638f-861f-40d8-8277-69a87a48de5e",
      "type": "breed",
      "attributes": {
        "name": "Jindo",
    ...
    {
      "id": "ed4e6095-eaf9-4e93-9736-705fbcf2ce68",
      "type": "breed",
      "attributes": {
        "name": "Mountain Cur",
    ...
    {
      "id": "5a9bd4e9-6346-4c40-ac39-f42b12da555b",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "4348208f-eb27-480f-bf3a-3f7c6b5de312",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "9926cd59-5614-4a14-91bd-d09959916bc4",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "caaa1a51-e60b-4192-ad2f-d7237b71ff40",
      "type": "breed",
      "attributes": {
        "name": "Schapendoes",
    ...
    {
      "id": "09be818d-ef06-4f25-a616-9ab5d7456c9c",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "f6eeac88-d62d-4ae7-9357-d3ca9bbc916a",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "15e35786-3ff3-4f59-87eb-d9dd84a29d07",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "8a2994b0-4868-4e2c-824e-56fcd8200e84",
      "type": "breed",
      "attributes": {
        "name": "Shikoku",
    ...
    {
      "id": "066e3871-bb5e-493f-9cd6-ccbf2a79c69f",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "a9d55c39-c2e0-4d55-884c-e2cf7c122e21",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "661e6c1f-2185-4e04-aa55-b2326172e233",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "ce0d81ac-55b1-4771-bd0b-7666a1f94f13",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "e855abe2-1a95-43e2-9323-13675cfcb041",
      "type": "breed",
      "attributes": {
        "name": "Stabyhoun",
    ...
    {
      "id": "914840ee-b091-4a9f-b827-099da31b4024",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "d122ef48-4840-4e30-beee-24ccb6bf3a46",
      "type": "breed",
      "attributes": {
    ...
    {
      "id": "0a044dcd-1f9a-4b83-b52c-ea898241fb25",
      "type": "breed",
      "attributes": {
        "name": "Welsh Terrier",
    ...
    {
      "id": "5b631664-c346-4e2c-89c5-ee0b82cafa6f",
      "type": "breed",
      "attributes": {
  ...
  "links": {
    "self": "https://dogapi.dog/api/v2/breeds?page[size]=1000",
    "current": "https://dogapi.dog/api/v2/breeds?page[number]=1&page[size]=1000"
  }
} 
-->
